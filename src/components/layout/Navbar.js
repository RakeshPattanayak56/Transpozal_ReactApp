                ...
                <div className="collapse navbar-collapse">
                    <ul className="navbar-nav me-auto mb-3 mb-lg-0">
                        ...
                        <li className="nav-item">
                            <a className="nav-link" class="thead-dark" href="/resources">
                                Resources
                            </a>
                        </li>
                        &nbsp;&nbsp;&nbsp;
                        <li className="nav-item">
                            <a className="nav-link" class="thead-dark" href="/union-Info">
                                Union-Info
                            </a>
                        </li>
                        &nbsp;&nbsp;&nbsp;
                        <li className="nav-item">
                            <a className="nav-link" class="thead-dark" href="/transporter">
                                Transporter
                            </a>
                        </li>
                    </ul>
